...
export const ChangeQuantityOfBook: React.FC<{ book: BookModel, delete: any }> = (props) => {
    ...
    async function increaseQuantity() {
        ...
        const requestOption = {
            ...
            const responseIncreasing = await fetch(url, requestOption);
            if (!responseIncreasing.ok) {
