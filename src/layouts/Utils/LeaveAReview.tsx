            ...
            {displayInput &&
                <form method='POST' action='#'>
                    ...
                    <div className="mb-3">
                        ...
                        <textarea className="form-control" id="submitReviewDescription" placeholder="Optional" rows={3} onChange={(e) => { setReviewDescription(e.target.value) }} value={reviewDescription}>
